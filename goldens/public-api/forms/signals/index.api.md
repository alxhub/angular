...
export class FormField<T> {
    ...
    // (undocumented)
    protected elementAcceptsNativeProperty<K extends ControlBindingKey>(key: K): key is K & ('min' | 'max' | 'minLength' | 'maxLength' | 'disabled' | 'required' | 'readonly' | 'name');
    readonly errors: Signal<ValidationError.WithFieldTree[]>;
    // (undocumented)
    ...
    // (undocumented)
    protected readonly nativeFormElement: NativeFormControl;
    ...
    // (undocumented)
    ɵngControlCreate(host: ɵControlDirectiveHost<'formField'>): void;
    // (undocumented)
...
export interface PrivateFormField extends Pick<FormField<unknown>, 'registerAsBinding' | 'element' | 'state' | 'errors'> {
    ...
    // (undocumented)
    elementAcceptsNativeProperty<K extends ControlBindingKey>(key: K): key is K & ('min' | 'max' | 'minLength' | 'maxLength' | 'disabled' | 'required' | 'readonly' | 'name');
    // (undocumented)
