...
import {FormArray, FormBuilder, FormControl, FormGroup} from '../src/forms';
...
describe('Typed Class', () => {
  describe('FormControl', () => {
    it('should support inferred controls', () => {
      ...
      }
      {
        ...
        // TODO(alxhub): this is not a thing?
  ...
  describe('FormGroup', () => {
    ...
    it('should support groups with the default type', () => {
      let c: FormGroup;
      c = new FormGroup({
        c: new FormControl('', {initialValueIsDefault: true}),
        d: new FormControl('', {initialValueIsDefault: true})
  ...
  describe('FormArray', () => {
    ...
    it('should support arrays with the default type', () => {
      let c: FormArray;
