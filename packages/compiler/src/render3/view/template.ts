...
import {LocalResolver, convertActionBinding, BindingForm, BuiltinFunctionCall, convertPropertyBinding} from '../../compiler_util/expression_converter';
import {Identifiers as R3} from '../r3_identifiers';

import {BoundElementBindingType, AST, AstMemoryEfficientTransformer, BindingPipe, PropertyRead, FunctionCall, LiteralPrimitive, ImplicitReceiver, LiteralArray, LiteralMap} from '../../expression_parser/ast';
import {asLiteral, CONTEXT_NAME, ID_SEPARATOR, I18N_ATTR, I18N_ATTR_PREFIX, IMPLICIT_REFERENCE, mapToExpression, MEANING_SEPARATOR, REFERENCE_PREFIX, RenderFlags, RENDER_FLAGS, temporaryAllocator, TEMPORARY_NAME, trimTrailingNulls, unsupported, invalid, noop} from './util';
import { ConstantPool } from '../../constant_pool';
import { SelectorMatcher, CssSelector } from '../../selector';
import { flatten } from '../../../../core/src/render3/util';
import { sanitizeIdentifier } from '../../compile_metadata';
import { error, OutputContext } from '../../util';
import { ParseSourceSpan } from '../../parse_util';
import { CompileReflector } from '../../compile_reflector';
import { IvyQueryMetadata } from './api';
...
export class TemplateDefinitionBuilder implements t.Visitor<void>, LocalResolver {
  ...
  constructor(
      ...
      private templateName: string|null, private viewQueries: IvyQueryMetadata[],
    ...
    this._valueConverter = new ValueConverter(
        constantPool, () => this.allocateDataSlot(), (name, localName, slot, value: o.ReadVarExpr) => {
  ...
  visitTemplate(template: t.Template) {
    ...
    const templateVisitor = new TemplateDefinitionBuilder(
        this.constantPool, templateContext, this._bindingScope,
...
function getLiteralFactory(
  ...
  const {literalFactory, literalFactoryArguments} =
      constantPool.getLiteralFactory(literal);
