...
import {compileComponent, compileDirectiveGlobal} from '../../src/render3/r3_view_compiler_local';
        ...
        for (const pipeOrDirective of pipesOrDirectives) {
          ...
          if (resolver.isDirective(pipeOrDirective)) {
            ...
            if (directive.isComponent) {
              ...
              compileDirectiveGlobal(outputCtx, directive, reflector, hostBindingParser);
            }
