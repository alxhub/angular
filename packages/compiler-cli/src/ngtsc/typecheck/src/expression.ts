...
import {AST, ASTWithSource, Interpolation, PropertyRead} from '@angular/compiler';
...
function astsToBinaryExpression(
    ast: AST[], maybeResolve: (ast: AST) => ts.Expression | null): ts.BinaryExpression {
