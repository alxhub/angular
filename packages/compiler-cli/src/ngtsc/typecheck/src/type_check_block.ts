...
import {AST, BindingPipe, BindingType, BoundTarget, ExpressionType, ImplicitReceiver, PropertyRead, TmplAstBoundAttribute, TmplAstBoundText, TmplAstElement, TmplAstNode, TmplAstTemplate, TmplAstTextAttribute, TmplAstVariable} from '@angular/compiler';
...
export function generateTypeCheckBlock(
  ...
  const tcb =
      new Context(meta.boundTarget, meta.pipes, node.getSourceFile(), importManager, refEmitter);
