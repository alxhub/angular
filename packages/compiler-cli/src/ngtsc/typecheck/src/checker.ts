...
import {AST, DomElementSchemaRegistry, MethodCall, ParseError, parseTemplate, PropertyRead, SafeMethodCall, SafePropertyRead, TmplAstNode, TmplAstReference, TmplAstTemplate, TmplAstVariable} from '@angular/compiler';
...
export class TemplateTypeCheckerImpl implements TemplateTypeChecker {
  ...
  private getScopeData(component: ts.ClassDeclaration): ScopeData|null {
    ...
    for (const dir of scope.compilation.directives) {
      ...
      if (moduleScopeOfDir !== null && moduleScopeOfDir !== 'error') {
