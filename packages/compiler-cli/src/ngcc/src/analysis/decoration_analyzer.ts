...
import {NpmReferenceResolver} from '@angular/compiler-cli/src/ngtsc/imports';
...
export class DecorationAnalyzer {
  ...
  resolver = new NpmReferenceResolver(this.program, this.typeChecker, this.options, this.host);
