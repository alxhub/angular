ChildComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ChildComponent, selectors: [["child-component"]], hostVars: 2, hostBindings: function ChildComponent_HostBindings(rf, ctx) { if (rf & 1) {
